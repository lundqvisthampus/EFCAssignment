    ...
    public partial class Init_Tables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieProviders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieProviderId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movies_MovieProviders_MovieProviderId",
                        column: x => x.MovieProviderId,
                        principalTable: "MovieProviders",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieProviders_ProviderName",
                table: "MovieProviders",
                column: "ProviderName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_MovieProviderId",
                table: "Movies",
                column: "MovieProviderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionCompanies_CompanyName",
